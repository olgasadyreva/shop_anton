...
?>
<!DOCTYPE html>
<!-- Last Published: Wed Dec 02 2020 13:43:13 GMT+0000 (Coordinated Universal Time) --><html data-wf-page="5f6c81234b5f85aa09926045" data-wf-site="5f61f4d1741820a756fe13e1">
...
<input type="submit" value="" class="search-button w-button"></form>
		...
		<div class="breadcrumbs">
			<div class="bc-text"><a href="/" class="bc-link">Главная</a> <span class="bc-sep">/</span> <a href="/blog" class="bc-link"><span class="bc-link">блог</span></a>  <span class="bc-sep">/</span> <a href="#" class="bc-link"><span><?php the_title(); ?></span></a></div>
		</div>
		<div class="posts">
			<div class="container">
...
<input type="submit" value="" class="search-button w-button"></form>
					...
					<div class="post">
						<?php if(have_posts()) : ?>
						<?php while (have_posts()) : the_post(); ?><img src="<?php echo get_template_directory_uri() ?>/images/5f61f77d11cb5e1fc61d7dfa_Rectangle-5.jpg" loading="lazy" wp="post image" alt="" class="post-image">
						<h1 class="post-title">
							<?php the_title(); ?>
						</h1>
						...
						<div class="post-content-single w-richtext">
							<?php the_content(); ?>
						</div>
						<?php endwhile; ?>
						<?php endif; ?>
